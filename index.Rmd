...
We trained a random forest model and achieved the accuracy of 99.41% with a 
5-fold repeated cross validation with 3 runs in the training data.

Finally, we used this model to evaluate 20 entries in the test set and we were
able to properly identify XX of the cases.
